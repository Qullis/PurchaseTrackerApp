            ...
            <div className="card">
                ...
                <div className="card-body">
                    ...
                    <ul className="list-group list-group-flush">
                        ...
                        {purchase.reciept && 
                            <li className="list-group-item"><button className="btn btn-secondary bi bi-card-text" data-bs-toggle="modal" data-bs-target="#recieptModal">View reciept</button></li>
                        }
                        <li className="list-group-item">
                            <Form method="post" className="d-inline">
                                <button type="submit" className="btn btn-danger mx-2 bi bi-trash"> Delete</button>
                            </Form>
                            <Link to={'/purchases/' + purchase.id + '/update'} className="btn btn-primary mx-2 bi bi-pencil-square"> Edit</Link>
                        </li>
                    </ul>
                </div>
            </div>
